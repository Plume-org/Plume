...
fn main() {
    ...
    copy("target/deploy/plume-front.wasm", "static/plume-front.wasm").unwrap();
    let js = read_to_string("target/deploy/plume-front.js").unwrap();
    write("static/plume-front.js", js.replace("\"plume-front.wasm\"", "\"/static/plume-front.wasm\"")).unwrap();
}
