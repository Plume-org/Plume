...
use crate::{
    Context, comments::Comment, follows,
    likes, posts::{Post, PostUpdate}, reshares::Reshare,
...
pub fn inbox(conn: &Connection, search: &Searcher, act: serde_json::Value) -> Result<InboxResult, Error> {
...
mod tests {
    ...
    fn fill_database(conn: &Conn) -> (Vec<crate::posts::Post>, Vec<crate::users::User>, Vec<crate::blogs::Blog>) {
        use crate::posts::*;
    ...
    fn test_announce_post() {
        ...
        conn.test_transaction::<_, (), _>(|| {
            ...
            match super::inbox(conn, &get_searcher(), act).unwrap() {
    ...
    fn test_delete_comment() {
        ...
        conn.test_transaction::<_, (), _>(|| {
            ...
            assert!(super::inbox(conn, &get_searcher(), fail_act).is_err());
            ...
            assert!(super::inbox(conn, &get_searcher(), ok_act).is_ok());
    ...
    fn test_undo_reshare() {
        ...
        conn.test_transaction::<_, (), _>(|| {
            ...
            let announce = Reshare::insert(conn, NewReshare {
                post_id: posts[0].id,
                user_id: users[1].id,
    ...
    fn test_undo_like() {
        ...
        conn.test_transaction::<_, (), _>(|| {
            ...
            let like = Like::insert(conn, NewLike {
                post_id: posts[0].id,
                user_id: users[1].id,
    ...
    fn test_update_post() {
        ...
        conn.test_transaction::<_, (), _>(|| {
            ...
            super::inbox(conn, &get_searcher(), act).unwrap();
